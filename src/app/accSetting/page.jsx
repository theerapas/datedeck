...
const page = () => {
  ...
  const definitions = {
    communicationEffectiveness:
      "Measures clear, open communication and conflict resolution.",
    emotionalStability:
      "Assesses composure, stress management, and emotional steadiness.",
    affectionConsistency:
      "Evaluates regular expressions of love through words and actions.",
    flexibilityLevel:
      "Measures adaptability to planned and unexpected situations.",
    supportiveness:
      "Assesses willingness to encourage, advise, and assist a partner.",
    openness: "Evaluates openness to new experiences and adventures.",
    conflictResolutionSkills:
      "Measures the ability to resolve conflicts constructively.",
  ...
  const handleNext = () => {
    ...
    onAuthStateChanged(auth, async (user) => {
      if (user) {
        ...
        const data = {
          weightCE: sliderValues.communicationEffectiveness,
          weightES: sliderValues.emotionalStability,
          weightAC: sliderValues.affectionConsistency,
          weightFL: sliderValues.flexibilityLevel,
          weightSU: sliderValues.supportiveness,
          weightOP: sliderValues.openness,
          weightCRS: sliderValues.conflictResolutionSkills,
          weightKG: sliderValues.kindnessGenerosity,
        };
        try {
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
              <div className="bg-[#572649] p-6 rounded-lg max-w-md w-full border border-white">
                <h2 className="text-xl font-bold mb-4">
                  Key Relationship Qualities & Scoring
                </h2>
